...
/// Material color based on Black for black and white theme
MaterialColor materialColorBlack = const MaterialColor(
  0xFF000000,
  <int, Color>{
    50: Color(0xFF000000),
...
/// Material color based on White for black and white theme
